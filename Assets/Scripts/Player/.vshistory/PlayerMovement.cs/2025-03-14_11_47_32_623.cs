...
public class PlayerMovement : MonoBehaviour
{
    ...
    [SerializeField] private float dashIFrameDuration = 0.4f; // I-frames during dash
    ...
    [SerializeField] private int bulletDamage = 1;           // Damage dealt by the bullet
    ...
    [SerializeField] private int ammo = 57;     // Initial ammo (optional, can be infinite)
    ...
    [SerializeField] private GameObject tablePrefab; // Prefab for a flippable table
    ...
    void Start()
    {
        ...
        if (fadePanel != null)
        {
            fadePanel.color = new Color(0, 0, 0, 0); // Ensure it's fully transparent at start
        }
