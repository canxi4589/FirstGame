...
public class PlayerMovement : MonoBehaviour
{
    ...
    public void Interact(InputAction.CallbackContext context)
    {
        ...
        {
            if (currentInteractable.CompareTag("DoorLock"))
            {
                if (keys > 0)
                {
                    keys--;
                    ...
                    if (lockObject != null)
                    {
                        ...
                        Collider2D doorCollider = currentInteractable.GetComponentInParent<Collider2D>();
        ...
        if (context.started && currentInteractable != null)
        {
            if (currentInteractable.CompareTag("DoorLock"))
            {
                if (keys > 0)
                {
                    ...
                    currentInteractable = null; // Clear the interactable after interaction
                }
                else
                {
                    Debug.Log("PlayerMovement: Not enough keys to unlock the door!");
    ...
    {
        if (other.CompareTag("DoorLock") && currentInteractable == other.gameObject)
        {
            currentInteractable = null;
